...
【重要】各企画の「target」は抽象的な層（「初心者〜中級者」等）ではなく、
具体的な一人のペルソナとして描写してください。
例: 「インスタを始めて3ヶ月、毎日投稿しているのにフォロワー500人で伸び悩んでいる28歳の副業OL。本業は事務職で、夜と休日にカフェ巡り投稿をしている」

また「inner_voice」にはそのペルソナの心の声（本音・不安・葛藤）を入れてください。
例: 「毎日頑張って投稿してるのに全然伸びない…才能ないのかな。周りはどんどんフォロワー増えてるのに、私だけ取り残されてる気がする」
...
{{
  ...
  "proposals": [
    {{"title": "タイトル案", "concept": "コンセプト", "target": "具体的な一人のペルソナ（年齢・職業・状況・悩みを含む）", "inner_voice": "そのペルソナの心の声（本音・不安・葛藤）", "uniqueness": "差別化ポイント"}}
  ]
}}"""
